...
# The sources are archived; the package is delivered into the active style.
OUT=next(p for p in ROOT.parents if p.name=='Assets')/'Graphics/1_NeonMonte_Attivo/Cards/_Final'
